...
export const enErrorMessage: IErrorMessage = {
  ...
  LIKE_DOES_NOT_EXIST: 'u already unlike this twitte bitch',
  ...
  ERROR_TWITTE_MIN: 'Min lenth is 1',
  ERROR_TWITTE_MAX: 'Min lenth is 700',
  ERROR_USER_USERNAME_MAX: 'Max lenth is 16',
  ERROR_EMPTY: 'this feild can not be empty',
  ERROR_STRING: 'this feild must be string',
  EMAIL_UserName_ALREADY_EXISTS: 'Email or UserName already exist ',
};
